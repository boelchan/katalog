...
<footer class="footer {{($configData['footerType']=== 'footer-hidden') ? 'd-none':''}} footer-light">
  <p class="clearfix mb-0">
    <span class="col-md-12 float-md-left d-block badge badge-light-success">
      {{ number_format($logPengunjung->jumlah) }} view <span class="far fa-eye"></span>
    </span>
    <span class="float-md-left d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2020<a class="ml-25" href="" target="_blank">Suami Tersayang</a>
